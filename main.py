    ...
    if response.status_code == 200:
        ...
        if "items" in data and len(data["items"]) > 0:
            ...
            return {
                ...
                "dislikes": "Unavailable (YouTube doesn't provide this anymore)",
...
def main():
    ...
    with tab2:
        ...
        if st.button("Compute Gratification Score"):
            g = calculate_gratification_score(
                likes, shares, comments, thumbnail_quality, keyword_score,
...
def show_admin_dashboard():
    ...
    feedback_data = pd.DataFrame(fetch_feedback())
